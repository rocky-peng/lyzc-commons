...
public class WeChatMiniProgramLoginUtils {
    ...
    private static final String ACCESS_TOKEN_URL_PATTEN = "https://api.weixin.qq.com/sns/jscode2session?appid=%s&secret=%s&js_code=%s&grant_type=authorization_code";
    ...
    public WeChatMiniProgramLoginUtils(String appId, String appSecret) {
        this.appId = appId;
